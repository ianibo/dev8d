...
from cook.forms import PersonForm
from cook.models import Contract, File, Person
...
def add_person(request):
    return create_object(request, form_class=PersonForm,
        post_save_redirect=reverse('cook.views.show_person',
...
def delete_person(request, key):
    return delete_object(request, Person, object_id=key,
        post_delete_redirect=reverse('cook.views.list_people'))
